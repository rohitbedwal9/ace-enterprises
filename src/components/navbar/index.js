        ...
        < div className="flex flex-col w-full">
            <div className="navbar flex bg-transparent justify-between items-center w-full pt-5 px-10 sm:py-6  " >
                ...
                <div>
                    ...
                    {isLogin ? (
                        <div>
                            {/* <button onClick={logout} className="flex  items-center border-2 border-black  hover:bg-gray-900 hover:text-white p-2 rounded-3xl sm:text-lg shadow-lg "   >SignOut</button> */}
                        ...
                        <Link href="/signup">
                            <button className="flex  items-center border-2 border-black  hover:bg-gray-900 hover:text-white p-2 rounded-3xl sm:text-lg shadow-lg " >Login / Register</button>
                        </Link>
                    )}
