...
export const Contact = () => {
  return (
    <div data-aos="fade-in" className="contact-section  bg-blue-500 flex justify-between flex-col-reverse  md:flex-row gap-8 items-center px-4 py-10 md:p-28  w-full h-full ">
      <div data-aos="fade-right" className="contact-box  mx-4 md:mx-6 flex flex-col gap-2 md:gap-10 items-start w-full h-full">
      ...
      <div data-aos="fade-left"  className="image-div   md:mx-10 flex justify-center w-full h-full">
