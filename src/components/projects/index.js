    ...
    <div className="py-5 md:px-20">
      <div className="flex md:flex-row gap-4 flex-col m-4 md:m-10 items-center">
        <div className="flex flex-col gap-4 p-4 md:p-10 align-center md:w-[70%]">
          ...
          <p className="text-xl font-semibold">We design curated residential spaces that are a beautiful reflection of what’s most important to you. Our portfolio spans all style disciplines, from traditional to contemporary and everything in between.</p>
        </div>
