...
export default function About() {
  return (
    <div className="min-h-screen">
      <Navbar />
      <ScrollUp />
      <div className="banner pb-10 h-full bg-no-repeat mx-auto  flex flex-col items-center  shadow-xl ">
        <PageHead heading="About" subheading="Know more about us" />
        <div className="flex flex-col  md:flex-row md:px-20 justify-between items-center gap-10">
          <div className="flex flex-col  w-[90%] md:w-[50%] mx-0 md:mx-10">
            ...
            <div className="text-gray-500 text-base sm:text-lg px-auto mt-6">
              ...
              Join us on this journey at Ace Enterprises, where every project is
              not just a construction endeavor but a meticulously crafted
        ...
        <div className="border-t-2 border-dashed border-blue-300 pt-6 text-gray-500  text-base sm:text-lg mx-auto mt-6 w-[90%] md:w-[80%]">
          Step into a realm where craftsmanship meets ingenuity, where each
          brick laid is a testament to our dedication. At Ace Enterprises, we
          don&apos;t just build structures; we weave dreams into reality. With a
          legacy steeped in tradition and a vision set on the horizon, we invite
          you to embark on a journey where every corner holds the promise of
          brilliance. Join us, and together, let&apos;s build a future where
      ...
      <div className="flex flex-col justify-center items-center my-10">
        ...
        <div className="flex flex-col md:flex-row items-center w-full md:px-10 ">
          ...
          <div className="description text-gray-500 text-base  md:px-20 w-[90%] md:w-[60%] flex flex-col items-center mt-4 md:mt-0 ">
            In the auspicious year of 2012, against the backdrop of a burgeoning
            industry, Mohammad Furqan embarked on a bold odyssey, sowing the
            seeds of Ace Enterprises with a profound vision for revolutionizing
            the landscape of civil construction. With an unwavering resolve and
            a fervent dedication to excellence, he meticulously nurtured Ace
            Enterprises, cultivating a culture steeped in innovation, integrity,
            and relentless pursuit of perfection. Mohammad Furqan&apos;s
            visionary leadership has not only propelled Ace Enterprises to the
            vanguard of the industry but has also transformed it into a
            veritable powerhouse of ingenuity and craftsmanship. Each project
            undertaken under his stewardship bears the hallmarks of his
            discerning eye and unwavering commitment to quality, earning
            accolades and admiration from peers and clients alike. As the
            custodian of Ace Enterprises illustrious legacy, Mohammad Furqan
            continues to chart a course towards new horizons of success, where
            the company&apos;s name becomes synonymous with unparalleled
            achievement and its contributions resonate as enduring testaments to
